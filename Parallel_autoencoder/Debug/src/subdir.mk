...
src/%.o: ../src/%.cpp
	...
	mpic++ -I/home/racanati/Parallel_autoencoder/opencv_release/include -I"/home/giovanni/git/repository/Parallel_autoencoder/opencv/include" -O0 -g3 -Wall -c -fmessage-length=0 -std=c++11 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
