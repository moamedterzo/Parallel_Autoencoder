...
src/%.o: ../src/%.cpp
	...
	g++ -I"/home/giovanni/git/repository/Parallel_autoencoder/opencv/include" -I../opencv_release/include -O0 -g3 -Wall -c -fmessage-length=0 -std=c++11 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
