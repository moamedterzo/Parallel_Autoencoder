...
src/%.o: ../src/%.cpp
	...
	mpic++ -std=c++11 -I/home/racanati/git/Parallel_autoencoder/opencv/include -I"/home/giovanni/git/repository/Parallel_autoencoder/opencv/include" -O3 -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
